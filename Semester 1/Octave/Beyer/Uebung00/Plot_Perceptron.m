...
function [] = Plot_Perceptron()
  % create test data
  [x, d] = PerceptronTestData(100, [1, 1], [4, 4], 0.8, 1);

  % let it learn
  [w, nw, ni, nmis, w_found, w_history] = Perceptron_Learner(x, d, 200);
  w_found
...
function [x, d] = PerceptronTestData(n, center1, center2, standardDeviation, normalize)
